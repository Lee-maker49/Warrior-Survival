 ...
 */
UCLASS()
class GASPRE_API UAbilityTask_ExecuteTaskOnTick : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	static UAbilityTask_ExecuteTaskOnTick* ExecTaskOnTick(UGameplayAbility* OwningAbility);
